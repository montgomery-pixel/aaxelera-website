      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16 md:h-20">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            ...
            className="inline-flex items-center text-[12px] font-medium tracking-[0.08em] uppercase rounded-full px-5 py-2 bg-black text-white/70 border border-white/[0.2] hover:border-white/[0.4] hover:text-white transition-all duration-300"
          >
